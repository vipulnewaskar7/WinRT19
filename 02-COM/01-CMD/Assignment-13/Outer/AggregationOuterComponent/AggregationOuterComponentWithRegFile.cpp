...
// CSumSubtract Constructor and Destructor
...
HRESULT CSumSubtract::InitializeInnerComponent(void)
{
	...
	if (FAILED(hr))
	{
		MessageBox(NULL, TEXT("IUnknown Interface cannot be found, program will exit now."), TEXT("Error"), MB_OK);
		return(E_FAIL);
	}
	...
	if (FAILED(hr))
	{
		MessageBox(NULL, TEXT("IMultiplication Interface cannot be found, program will exit now."), TEXT("Error"), MB_OK);
	...
	if (FAILED(hr))
	{
		MessageBox(NULL, TEXT("IDivision Interface cannot be found, program will exit now."), TEXT("Error"), MB_OK);
		m_pIUnknownInner->Release();
		m_pIUnknownInner = NULL;
		return(E_FAIL);
	}
